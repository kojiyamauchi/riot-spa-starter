...
var riot = __webpack_require__(27);
//src: tags/app.tag

riot.tag2('app', '<global-header></global-header> <main-contents></main-contents> <global-footer></global-footer>', 'app,[data-is="app"]{ display: block; width: 100%; height: 100vh; position: relative; background-image: url("../riot-spa-starter-kit/images/bg.jpg"); background-size: cover; background-position: center; background-repeat: no-repeat; } @media screen and (max-width: 768px) { app,[data-is="app"]{ background-size: contain; } }', '', function (opts) {});
...
var riot = __webpack_require__(27);
//src: tags/components/footer/global-footer.tag

riot.tag2('global-footer', '<a href="https://github.com/kojiyamauchi/riot-spa-starter-kit" class="l-link__github">{gitHub}</a> <br> <a href="http://kojiyamauchi.com" class="l-link__footer">{myPortfolio}</a>', 'global-footer,[data-is="global-footer"]{ width: 100%; position: absolute; left: 0; bottom: 0; display: block; text-align: center; padding: 40px 0; } global-footer .l-link__github,[data-is="global-footer"] .l-link__github{ display: inline-block; margin: 0 0 15px; } global-footer .l-link__footer,[data-is="global-footer"] .l-link__footer{ font-family: Lobster,cursive; font-size: 1.5em; cursor: pointer; display: inline-block; }', '', function (opts) {
...
var riot = __webpack_require__(27);
//src: tags/components/header/global-header.tag

riot.tag2('global-header', '<h1 class="u-heading01">{heading01}</h1> <global-nav></global-nav>', 'global-header,[data-is="global-header"]{ display: block; width: 100%; padding: 40px 0; } global-header .u-heading01,[data-is="global-header"] .u-heading01{ font-size: 3.875em; text-align: center; margin: 0 0 40px; }', '', function (opts) {
    this.heading01 = 'Riot.js SPA Starter Kit.';
});
...
var riot = __webpack_require__(27);
//src: tags/components/navigation/global-nav.tag

riot.tag2('global-nav', '<ul class="l-nav-box"> <li each="{lists}" class="l-nav-list"> <a href="/riot-spa-starter-kit{path}" class="l-nav-link">{link}</a> </li> </ul>', 'global-nav .l-nav-box,[data-is="global-nav"] .l-nav-box{ display: flex; justify-content: space-between; align-items: center; width: 60vw; margin: 0 auto; } global-nav .l-nav-box .l-nav-link,[data-is="global-nav"] .l-nav-box .l-nav-link{ font-size: 1.375em; }', '', function (opts) {
  this.lists = [{
    path: '/',
    link: 'Top Page'
  }, {
...
var riot = __webpack_require__(27);
//src: tags/pages/second-page.tag

riot.tag2('second-page', '<h2 class="u-heading02">{heading02}</h2>', 'second-page,[data-is="second-page"]{ width: 100%; height: calc(100% - 204px - 108px); display: flex; justify-content: center; align-items: center; } second-page .u-heading02,[data-is="second-page"] .u-heading02{ font-size: 3em; transform: translateY(-140%); text-shadow: 1px 1px 2px #fff; }', '', function (opts) {
...
var riot = __webpack_require__(27);
//src: tags/pages/third-page.tag

riot.tag2('third-page', '<h2 class="u-heading02">{heading02}</h2>', 'third-page,[data-is="third-page"]{ width: 100%; height: calc(100% - 204px - 108px); display: flex; justify-content: center; align-items: center; } third-page .u-heading02,[data-is="third-page"] .u-heading02{ font-size: 3em; transform: translateY(-140%); text-shadow: 1px 1px 2px #fff; }', '', function (opts) {
    this.heading02 = 'This is Third Page.';
});
...
var riot = __webpack_require__(27);
//src: tags/pages/top-page.tag

riot.tag2('top-page', '<h2 class="u-heading02">{heading02}</h2>', 'top-page,[data-is="top-page"]{ width: 100%; height: calc(100% - 204px - 108px); display: flex; justify-content: center; align-items: center; } top-page .u-heading02,[data-is="top-page"] .u-heading02{ font-size: 3em; transform: translateY(-140%); text-shadow: 1px 1px 2px #fff; }', '', function (opts) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_riot_observable__ = __webpack_require__(337);
...
var _riot = __webpack_require__(27);

var _riot2 = _interopRequireDefault(_riot);

var _riotRoute = __webpack_require__(134);
...
_riotRoute2.default.base('/riot-spa-starter-kit/'); // Setting Base Route.
// Set up SPA.
(0, _riotRoute2.default)('/', function () {
  return _riot2.default.mount('main-contents', 'top-page');
});
(0, _riotRoute2.default)('/second', function () {
  return _riot2.default.mount('main-contents', 'second-page');
});
(0, _riotRoute2.default)('/third', function () {
  return _riot2.default.mount('main-contents', 'third-page');
});
// Router Start.
